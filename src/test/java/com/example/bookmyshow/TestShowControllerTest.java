...
import com.example.bookmyshow.controllers.ShowController;
...
@SpringBootTest
public class TestShowControllerTest {
    ...
    public void testCreateShow_Success(){
        ...
        createShowRequestDTO.setPricingConfig(List.of(Pair.of(SeatType.GOLD, 500), Pair.of(SeatType.SILVER, 300)));
